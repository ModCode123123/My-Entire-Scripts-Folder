...
local ViewportRange = 90 -- Maximum distance players are updated

local RagdollEnabled = false -- Use your character instead of hats (NetworkOwner vulnerability)
local RagdollHeadMovement = false -- Move your head separately from your body (+9 second wait)
...
--]]
	...
	local function CreateAccessory(Accessory, DeleteMeshes)
		...
		return Handle, HatAtt, HeadAtt, BasePart;
	end
...
--]]
	...
	RunService.Heartbeat:Connect(function()
		if VRReady == false then
			LeftHandle.CFrame = VirtualRig.LeftUpperArm.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))
			RightHandle.CFrame = VirtualRig.RightUpperArm.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))
			LeftHipHandle.CFrame = VirtualRig.LeftFoot.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))*CFrame.new(0,0,0-1)
			RightHipHandle.CFrame = VirtualRig.RightFoot.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))*CFrame.new(0,0,-1)
			TorsoHandle.CFrame = VirtualRig.UpperTorso.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))
		else
			LeftHandle.CFrame = VirtualRig.LeftHand.CFrame*CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))*CFrame.new(0,0,0.8)
			RightHandle.CFrame = VirtualRig.RightHand.CFrame*CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))*CFrame.new(0,0,0.8)
			LeftHipHandle.CFrame = VirtualRig.LeftFoot.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))*CFrame.new(0,0,0-1)
			RightHipHandle.CFrame = VirtualRig.RightFoot.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))*CFrame.new(0,0,-1)
			TorsoHandle.CFrame = VirtualRig.UpperTorso.CFrame*CFrame.Angles(math.rad(90), math.rad(0), math.rad(0))
		end
		for i,x in pairs(Character:GetChildren()) do
			if x:IsA("Accessory")  then 
				if x.Name == AccessorySettings.LeftArm or x.Name == AccessorySettings.RightArm or x.Name == AccessorySettings.LeftLeg or x.Name == AccessorySettings.RightLeg or x.Name == AccessorySettings.Torso then
					...
					x.Handle.CFrame = VirtualRig.Head.CFrame*CFrame.new(0,0.55,0)
				end
