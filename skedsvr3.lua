...
game.Players.LocalPlayer.Character["Speakat"].Handle.Transparency = 1
...
options.headhat = "Speakat" -- name of the accessory which you are using as a head
...
char.Humanoid.MaxHealth = 9999999999999999999999999999
char.Humanoid.Health = 999999999999999999
