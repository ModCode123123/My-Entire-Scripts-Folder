...
local Hat1 = char:FindFirstChild(FingerHat)
...
if HeadscaleChangable == true then
	InputService.InputBegan:Connect(function(input)
		if input.KeyCode == Enum.KeyCode.ButtonX then
			Camera.HeadScale = Camera.HeadScale - 0.5
		end
	end)
	InputService.InputBegan:Connect(function(input)
...
--[[local AttachmentHat1 = Instance.new("Attachment")
AttachmentHat1.Parent = Hat1.Handle
local AttachmentHat2 = Instance.new("Attachment")
AttachmentHat2.Parent = VRRHand.Handle
Hat1.Handle.CFrame = VRRHand.Handle.CFrame
local weld = Instance.new("Weld")
weld.Parent = Hat1.Handle
weld.Part0 = Hat1.Handle
weld.Part1 = VRRHand.Handle]]
