...
--[[---------Settings---------]]--
local bodyVelocity = {0, 30, 0} --Change your body parts' velocity. First number value is the X value. Second number value is the Y value. Third number value is the Z value.
...
cHumanoid.BreakJointsOnDeath = false
--Head Mesh--
...
rArm1 = reanimation["Right Arm"]

--Left Arm Attachment
lArm1 = reanimation["Left Arm"]
    ...
    game:GetService("RunService").Heartbeat:Connect(function()
        ...
        for i,v in pairs(character1:GetChildren()) do
            ...
            if v.Name == "HumanoidRootPart" then
                ...
                v.Velocity = Vector3.new(hrpVelocity[1], hrpVelocity[2], hrpVelocity[3])
            end
            ...
            if v:IsA("Tool") then
                v.Handle.Velocity = Vector3.new(toolVelocity[1], toolVelocity[2], toolVelocity[3])
            end
        end
    end)
