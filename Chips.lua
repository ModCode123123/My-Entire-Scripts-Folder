...
UserInputService.InputBegan:Connect(function(key)
	if key.KeyCode == Enum.KeyCode.End then
			Player.Character = ReanimationRig.Parent
			wait(2)
			Player.Character.Humanoid.Health = 0
			ReanimationRig.Parent:FindFirstChildOfClass("Humanoid"):TakeDamage(math.huge)
	--ReanimationRig.Parent:FindFirstChildOfClass("Humanoid"):Destroy()
	end
end)
local AnimatorNIL = Instance.new("LocalScript", ReanimationRig)
AnimatorNIL.Name = "Animate"
local AnimatorNIL2 = Instance.new("Animator", ReanimationRig:FindFirstChildOfClass("Humanoid"))
AnimatorNIL2.Name = "Animator"
...
local UserInputService = game:GetService("UserInputService")
local ContextActionService = game:GetService("ContextActionService")
local LeftReani = char["Pal Hair"]
local RightReani = char["LavanderHair"]
local LeftHipReani = char["Kate Hair"]
local RightHipReani = char["Hat1"]
local TorsoReani = char["SeeMonkey"]
local HeadReani = char[HeadHat]
local BagHat = char["RedBeanieWithHair"]
...
Align(HeadReani.Handle,ReanimationRig["Head"],CFrame.new(0,0.3,0)*CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)))
wait()
...
local Create = loadstring(game:HttpGet("https://pastebin.com/raw/ekzr6CWi"))
...
RHe = IT("Part")
RHe.Parent = Chips
Align(BagHat.Handle,RHe,CFrame.new(0,0,0))
